...
class Player(tk.Frame):
	...
	def create_frames(self):
		self.track = tk.LabelFrame(self, text='Song Track', 
					...
					bg="#000",fg="white",bd=5,relief=tk.GROOVE)
		...
		self.controls = tk.LabelFrame(self,
							font=("times new roman",15,"bold"),
							bg="#000",fg="white",bd=2,relief=tk.GROOVE)
	...
	def control_widgets(self):
		self.loadSongs = tk.Button(self.controls, fg='#fdb827', bg='#21209c', font=10)
	...
	def play_song(self, event=None):
		if event is not None:
			...
			for i in range(len(self.playlist)):
				self.list.itemconfigure(i, bg="#c9cbff")
		...
		self.list.itemconfigure(self.current, bg='#bc6ff1')
